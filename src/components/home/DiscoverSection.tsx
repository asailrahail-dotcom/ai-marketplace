    ...
    <section className="section pt-10 md:pt-14">
      <div className="container-content">
        <div className="max-w-2xl mb-10 md:mb-14">
          <p className="eyebrow eyebrow-line mb-4">DISCOVER</p>
        ...
        <div className="grid md:grid-cols-3 gap-px bg-line border border-line">
          {PILLARS.map((p) => (
            <Link
              key={p.href}
              href={p.href}
              className="group relative bg-paper p-8 min-h-[260px] flex flex-col justify-end overflow-hidden hover:bg-sand transition-colors"
            >
              ...
              <span className="inline-flex items-center gap-1 font-semibold text-sm text-accent">
                استكشف
